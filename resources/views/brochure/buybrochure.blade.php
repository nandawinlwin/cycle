...
<div class="panel panel-default">
    ...
    <div class="panel-heading">
        ...
        <div class="panel-body" style="height:450px; overflow: scroll;">
            ...
            <div class="btn-group">
                <a href="{{url('voucher/sale')}}" class="btn btn-sm btn-info">Sale</a>
                <a href="{{url('voucher/buy')}}" class="btn btn-sm btn-primary">Byu</a>
            </div>
            <br><br>
            ...
            <table class="table table-bordered table-condensed table-hover fixed-top" style="width:100%;overflow: scroll;" id="dataTable" width="100%" cellspacing="0">
                <thead>
                  <tr>
                    ...
                    <th style="text-align:center;font-size:12px">Buy Date</th>
