...
<div class="btn-group">
      <a href="{{url('analysis')}}" class="btn btn-primary">Today</a>
      <a href="{{url('analysis/7/day')}}" class="btn btn-primary">7 Day</a>
      <a href="{{url('analysis/30/day')}}" class="btn btn-primary">Month</a>
      <a href="{{url('analysis/filter')}}" class="btn btn-primary " data-toggle="modal" data-target="#myModal">Filter</a>
</div>
